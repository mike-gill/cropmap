...
OpenSpaceOl3.prototype.getGazetteerQueryUrl = function (query) {
    return "http://openspace.ordnancesurvey.co.uk/osmapapi/gazetteer?q=" +
        encodeURI(query) +
        "&key=" +
        this.key +
        "&f=json&url=" +
...
OpenSpaceOl3.prototype.getPostcodeQueryUrl = function (code) {
    return "http://openspace.ordnancesurvey.co.uk/osmapapi/postcode?q=" +
        encodeURI(code) +
        "&key=" +
        this.key +
        "&f=json&url=" +
...
OpenSpaceOl3.prototype.getTileQuotaUrl = function () {
    return "http://openspace.ordnancesurvey.co.uk/osmapapi/jsapi?q=tilecount&key=" +
        this.key +
        "&f=json&url=" +
        this.url;
};
